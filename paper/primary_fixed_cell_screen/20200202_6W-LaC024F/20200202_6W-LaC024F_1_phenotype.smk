...
CHANNELS = [['DAPI-GFP','A594','AF750'],['GFP']]
CYCLES = ['DAPI-GFP-A594-AF750','GFP']
...
rule correct_align:
    ...
    run:
        ...
        aligned_A594 = Snake._align_phenotype_channels(data=stacked,target=0,source=2,riders=3)
        Snake.align_phenotype_channels(output=output,data=aligned_A594,target=1,source=4,remove='target')
