...
# DRIFT_FRAMES = 5 # no significant stage drift observed
...
rule apply_illumination_correction:
    ...
    threads: 2
    run:
        Snake.apply_illumination_correction(output=output,data=input[0],correction=input[1],n_jobs=threads)
