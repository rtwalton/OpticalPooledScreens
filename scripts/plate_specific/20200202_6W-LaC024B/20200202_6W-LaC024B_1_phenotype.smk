...
CHANNELS = [['GFP-DAPI','A594'],['A594','AF750']]
CYCLES = ['DAPI-GFP-A594','A594-AF750']
...
rule correct_align:
    ...
    run:
        ...
        aligned_A594 = Snake._align_phenotype_channels(data=stacked[[1,0,2,3,4]],target=0,source=2)
        Snake.align_phenotype_channels(output=output,data=aligned_A594,target=2,source=3,riders=4,remove='source')
