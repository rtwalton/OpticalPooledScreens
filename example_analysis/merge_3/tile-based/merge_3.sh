...
# Execute Snakemakes
snakemake -s hash_3.smk --use-conda --profile /lab/barcheese01/screens/denali/merge_3/snakemake-configs --latency-wait 60 --rerun-incomplete
...
# Execute Snakemakes
snakemake -s merge_3.smk --use-conda --profile /lab/barcheese01/screens/denali/merge_3/snakemake-configs --latency-wait 60 --rerun-incomplete