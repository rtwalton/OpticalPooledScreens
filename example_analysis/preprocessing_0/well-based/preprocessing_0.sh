...
snakemake -s preprocessing_0.smk --unlock

snakemake -s preprocessing_0.smk --rulegraph | dot -Tpdf > preprocessing_0/preprocessing_0.pdf

# Execute Snakemake
snakemake -s preprocessing_0.smk --use-conda --profile /lab/barcheese01/screens/aconcagua/preprocessing_0/snakemake-configs --latency-wait 60
