...
from ops.intake.common import parse_nd2_filename, export_nd2
import os
...
def process_files(files,**kwargs):
     ...
     def process_site(f,remove=False,iter_axes='m',project_axes=False,
               split=True,backend='ND2SDK',**kwargs):
