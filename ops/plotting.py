...
def volcano(
    ...
    **kwargs
    ...
    if xscale == "symlog":
        ...
        # x_min, x_max = np.ceil(np.log10(abs(df_[x].min()))), np.ceil(
        #     np.log10(abs(df_[x].max()))
        # )
        ...
        #             [
        #                 f"$\\mathdefault{{-10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(x_min, x_max, int(x_min - x_max) + 1)
        #             ]
        #         )
        ...
        #             [
        #                 f"$\\mathdefault{{-10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(x_min, 0, int(x_min) + 1)
        #             ]
        #         )
        ...
        #             [
        #                 f"$\\mathdefault{{10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(x_min, x_max, int(x_max - x_min) + 1)
        #             ]
        #         )
        ...
        #             [
        #                 f"$\\mathdefault{{10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(0, x_max, int(x_max) + 1)
        #             ]
        #         )
...
def two_feature(
    ...
    **kwargs
    ...
    if yscale == "symlog":
        ...
        #     SymmetricalLogLocator(base=10, linthresh=0.1, subs=np.arange(1, 10))
        # )
        # y_min_sign, y_max_sign = np.sign(df_[y].min()), np.sign(df_[y].max())
        # y_min, y_max = np.ceil(np.log10(abs(df_[y].min()))), np.ceil(
        #     np.log10(abs(df_[y].max()))
        # )
        # ax.set_ylim([y_min_sign * 10 ** y_min, y_max_sign * 10 ** y_max])
        ...
        #             [
        #                 f"$\\mathdefault{{-10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(y_min, y_max, int(y_min - y_max) + 1)
        #             ]
        #         )
        #         yticks.append(-np.logspace(y_min, y_max, int(y_min - y_max) + 1))
        #     else:
        #         yticklabels.extend(
        #             [
        #                 f"$\\mathdefault{{-10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(y_min, 0, int(y_min) + 1)
        #             ]
        #         )
        #         yticks.append(-np.logspace(y_min, 0, int(y_min) + 1))
        ...
        #             [
        #                 f"$\\mathdefault{{10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(y_min, y_max, int(y_max - y_min) + 1)
        #             ]
        #         )
        #         yticks.append(np.linspace(y_min, y_max, int(y_max - y_min) + 1))
        #     else:
        #         yticklabels.append("0")
        #         yticklabels.extend(
        #             [
        #                 f"$\\mathdefault{{10^{{{int(n)}}}}}$"
        #                 for n in np.linspace(0, y_max, int(y_max) + 1)
        #             ]
        #         )
        #         yticks.append(np.array([0]))
        #         yticks.append(np.logspace(0, y_max, int(y_max) + 1))
