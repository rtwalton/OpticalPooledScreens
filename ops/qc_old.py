"""
SBS Base Calling Quality Control Utilities

This module provides a collection of functions for quality control (QC) for in situ sequencing
(step 2 -- sbs base calling). It includes functions for:

1. Read Distribution: Plotting histograms of the number of reads per cell to assess sequencing depth.
2. Barcode Analysis: Evaluating and visualizing the distribution of barcodes.
3. Error Rates: Calculating and plotting sequencing error rates.
4. Quality Metrics: Summarizing various QC metrics such as read counts, error rates, and barcode diversity.
5. Visualization: Generating plots for visual inspection of sequencing quality.
