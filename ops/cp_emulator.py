...
# {'correlation_0':'{first}_{second}_corr',
# 'correlation_1':''
# }
...
intensity_features = {
    ...
    'max_location_r': lambda r: np.unravel_index(np.argmax(r.intensity_image*r.image), (r.image).shape)[0],
    'max_location_c': lambda r: np.unravel_index(np.argmax(r.intensity_image*r.image), (r.image).shape)[1]
    }
...
texture_features = {
	'haralick_5'  : lambda r: ubyte_haralick(np.multiply(r.intensity_image,r.image), ignore_zeros=True, distance=5,  return_mean=True),
	'haralick_10' : lambda r: ubyte_haralick(np.multiply(r.intensity_image,r.image), ignore_zeros=True, distance=10, return_mean=True),
	'haralick_20' : lambda r: ubyte_haralick(np.multiply(r.intensity_image,r.image), ignore_zeros=True, distance=20, return_mean=True)
}
